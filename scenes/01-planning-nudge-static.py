...
# 仿真参数配置
LGSVL__SIMULATION_DURATION_SECS = 30.0
...
destination = ego_state.position + 200 * forward  # 自车前方200m作为目的地
dv.setup_apollo(destination.x, destination.z, default_modules, default_timeout=600.0)
...
# 在右侧车道添加障碍物（同车道前方）
print("Adding obstacle in right lane...")
obstacle = create_npc(sim, ego_state, 50, 1.0, 'Sedan', 0.0)
obstacle.on_collision(on_collision)
